...
#set caze       = "ape-pqm-ih4ih3"
#set caze       = "ape-ppm-1yr"
#set caze       = "ape-pcm-1yr"
set caze       = "ape-pqm-1yr"
...
/home/mvalera/src/$src/cime/scripts/create_newcase --case /scratch/cluster/mvalera/$caze --compset QPC4  --res ne30_ne30_mg16 --walltime 32:00:00 --q verylong --pecount 192 --compiler nag --run-unsupported
...
echo "ncdata = '/scratch/cluster/mvalera/ape-spinup-restart/run/ape-spinup-restart.cam.i.0001-03-01-00000.nc'" >> user_nl_cam
